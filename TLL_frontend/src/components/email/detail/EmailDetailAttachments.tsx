...
export const EmailDetailAttachments: React.FC<EmailDetailAttachmentsProps> = ({
  ...
  return (
    <div className="mb-4 p-3 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg">
      <div className="flex items-center gap-2 mb-2 text-sm text-gray-700 dark:text-slate-300">
        ...
        {attachments.map((attachment: any, idx) => {
          ...
          return (
            <button
              ...
              disabled={isLoading}
              className="flex items-center gap-2 px-3 py-2 bg-gray-50 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-600 transition-colors text-sm disabled:opacity-50"
            >
