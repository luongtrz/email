  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="w-full flex items-center justify-between gap-2 px-3 py-2 border border-gray-300 rounded-lg hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
      >
        <div className="flex items-center gap-2 overflow-hidden">
          <Tag className="w-4 h-4 text-gray-400 flex-shrink-0" />
          <span className={`text-sm truncate ${selectedLabelId ? 'text-gray-900' : 'text-gray-500'}`}>
            {displayText}
          </span>
        </div>
        <svg
            ...
            <div className="overflow-y-auto max-h-60">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700">No label</span>
