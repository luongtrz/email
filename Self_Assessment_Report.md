...
| **6** | **AI Features** |  |  |  |  |
|  | AI Summarization |  |  |  |  |
|  | › Backend summarization API | \-0.5 | 0 |  | GEMINI integration to summarize email content |
...
|  | › Vector database storage | \-0.5 | 0 |  | Store embeddings in vector database (pgvector) |
| **7** | **Search Features** |  |  |  |  |
...
| **8** | **Filtering & Sorting** |  |  |  |  |
|  | Sort by date (newest/oldest) | \-0.25 | 0 |  | Two sorting options available |
...
|  | Gmail Push Notifications | 0.25 | 0 |  | (Future Improvement) Real-time inbox updates via Gmail watch |
|  | Multi-tab logout sync | 0.25 | 0 |  | (Future Improvement) BroadcastChannel for logout sync |
|  | Offline caching | 0.25 | 0 |  | (Future Improvement) IndexedDB caching |
|  | Keyboard navigation | 0.25 | 0.25 |  | Navigate emails with keyboard shortcuts (Implemented) |
|  | Dockerize your project | 0.25 | 0 |  | (Future Improvement) Docker setup |
|  | CI/CD | 0.25 | 0 |  | (Future Improvement) CI/CD pipeline |
...
| :---- | :---- | :---- | :---- | :---- |
| https://github.com/luongtrw.png | luongtrz / luongtrw | 34 | ~5000 | ~2000 |
| https://github.com/htloc0610.png | htloc0610 / Huỳnh Tấn Lộc | 6 | ~3000 | ~1000 |
| https://github.com/Tondeptrai23.png | Tondeptrai23 / Luu Thai Toan | 11 | ~1000 | ~500 |

## **Commits**

| Date | Author | Commit Message | Files Changed |
| :---- | :---- | :---- | :---- |
| 2026-01-20 | luongtrz | docs: Add Teamwork Collaboration Report | 1 |
| 2026-01-20 | Trần Lượng | fix(core): Resolve Attachment download and Data integration bugs | 7 |
| 2026-01-20 | luongtrz | fix(kanban): Fix Load More logic and Filter issues | 5 |
| 2026-01-20 | luongtrz | feat(search): Optimize search and add utility features | 6 |
| 2026-01-20 | luongtrz | style(ui): Enhance Dark Mode support and UI layout | 12 |
| 2026-01-20 | Trần Lượng | Merge pull request #9 from htloc0610/responsive | 8 |
| 2026-01-20 | luongtrz | feat(email): enhance trash management functionality | 4 |
| 2026-01-20 | luongtrz | feat(ui): Responsive Layout & UI Improvements | 15 |
| 2026-01-19 | luongtrz | feat: dark mode implementation for kanban board and modals | 9 |
| 2026-01-19 | luongtrz | feat: dark mode support for email list and search components | 7 |
...
- Semantic search using vector embeddings (pgvector) for conceptual relevance
- Dynamic Kanban configuration with Gmail label mapping
- Full email actions: compose, reply, forward, delete, attachments

## Technology Stack
- **Architecture:** React SPA + Backend API (Node.js/NestJS)
- **Frontend:** React, React Query, TailwindCSS, Zustand
...
| GET /api/emails/mailboxes | List Gmail labels/folders |
| GET /api/emails | List emails in mailbox with pagination |
| GET /api/emails/:id | Get email detail |
| POST /api/emails/send | Send new email |
| POST /api/emails/:id/reply | Reply to email |
| PATCH /api/emails/:id/modify | Mark read/unread, star, delete |
| GET /api/emails/:id/attachments/:attachmentId | Stream attachment |
| POST /api/emails/search | Fuzzy/Semantic search emails |
| GET /api/kanban | Get Kanban emails |
| POST /api/kanban/:id/status | Update email status (move columns) |
| POST /api/kanban/:id/snooze | Snooze email |
...
4. **AI Summary:** Email synced → Gemini summarizes → Summary displayed on card
...
| Week 5 | Deployment & Deliverables | Testing, deployment, documentation |
